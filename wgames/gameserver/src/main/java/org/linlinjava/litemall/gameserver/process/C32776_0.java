    ...
    public void process(ChannelHandlerContext ctx, ByteBuf buff) {
            ...
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (goods.pos == pos) {
                    ...
                    if (goods.goodsInfo.attrib >= 100) {
                        ...
                        if(!GameUtil.removemunber(chara, current, 2)) {
                        	return;
                        }
                        
                    } else {
                    	if(!GameUtil.removemunber(chara, "超级女娲石", 2)) {
                        	return;
                        }
        ...
        if (6 == type) {
            ...
            if (pos3 == 1) {
                ...
                if(!GameUtil.removemunber(chara, current, owner_id * 3)) {
                	return;
                }
                ...
                if (zhuangbeiInfo.getAttrib() <= 70) {
                	if(!GameUtil.removemunber(chara, current, 3)) {
                    	return;
                    }
                    ...
                    if(!GameUtil.removemunber(chara, current, 1)) {
                    	return;
                    }
                    if(!GameUtil.removemunber(chara, "超级女娲石", 2)) {
                    	return;
        ...
        if (24 == type) {
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (pos == goods.pos) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "装备共鸣石", pos1)) {
                    	return;
                    }
        ...
        if (5 == type) {
            ...
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (pos == goods.pos) {
                    ...
                    vo_20481_0.time = 1562987118;
                    GameObjectChar.send(new M20481_0(), vo_20481_0);
                    if(!GameUtil.removemunber(chara, "超级绿水晶", 1)) {
                    	return;
                    }
        ...
        if (3 == type) {
            ...
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (pos == goods.pos) {
                    ...
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if (iswuqi == 1) {
                    	if(!GameUtil.removemunber(chara, "超级灵石", pos1)) {
                        	return;
                        }
                        
                    } else {
                    	if(!GameUtil.removemunber(chara, "超级晶石", pos1)) {
                        	return;
                        }
        ...
        if (8 == type) {
            ...
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (goods.pos == pos) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "黄水晶", pos2)) {
                    	return;
                    }
        ...
        if (7 == type) {
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (goods.pos == pos) {
                    ...
                    if(!GameUtil.removemunber(chara, "超级粉水晶", 1)) {
                    	return;
                    }
        ...
        if (10 == type) {
            ...
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (goods.pos == pos) {
                    ...
                    if(!GameUtil.removemunber(chara, "超级圣水晶", 1)) {
                    	return;
                    }
        ...
        if (type == 2) {
            ...
            for (int i = 0; i < chara.backpack.size(); i++) {
                ...
                if (chara.backpack.get(i).pos == pos) {
                    ...
                    vo_20481_0.time = 1562987118;
                    GameObjectChar.send(new M20481_0(), vo_20481_0);
                    if(!GameUtil.removemunber(chara, "超级黑水晶", 1)) {
                    	return;
                    }
                    
                    if (para.equals("3")) {
                    	if(!GameUtil.removemunber(chara, "混沌玉", 1)) {
                        	return;
                        }
