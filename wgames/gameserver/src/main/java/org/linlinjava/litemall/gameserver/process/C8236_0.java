        ...
        for (int i = 0; i < chara.backpack.size(); i++) {
            if (chara.backpack.get(i).pos == pos) {
                ...
                if (goods.goodsInfo.str.equals("血池")) {
                    ...
                    if(!GameUtil.removemunber(chara, "血池", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("中级血池")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "中级血池", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("高级血池")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "高级血池", 1)) {
                    	return;
                    }
                }
                if (goods.goodsInfo.str.equals("灵池")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "灵池", 1)) {
                    	return;
                    }
                }
                if (goods.goodsInfo.str.equals("中级灵池")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "中级灵池", 1)) {
                    	return;
                    }
                }
                if (goods.goodsInfo.str.equals("高级灵池")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "高级灵池", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("驯兽诀")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "驯兽诀", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("超级仙风散")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "超级仙风散", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("神木鼎")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "神木鼎", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("紫气鸿蒙")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "紫气鸿蒙", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("如意刷到令")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "如意刷到令", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("急急如律令")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "急急如律令", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("宠风散")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "宠风散", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("高级驯兽诀")) {
                    ...
                    ListVo_65527_0 listVo_65527_0 = GameUtil.a65527(chara);
                    GameObjectChar.send(new M65527_0(), listVo_65527_0);
                    if(!GameUtil.removemunber(chara, "高级驯兽诀", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("灵物囊")) {
                    ...
                    if(!GameUtil.removemunber(chara, "灵物囊", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("天书")) {
                    ...
                    if(!GameUtil.removemunber(chara, "天书", 1)) {
                    	return;
                    }
                ...
                if (goods.goodsInfo.str.equals("超级藏宝图")) {
                    ...
                    if(!GameUtil.removemunber(chara, "超级藏宝图", 1)) {
                    	return;
                    }
